...
import { FolderOpen, RefreshCw, Search, FolderSymlink } from 'lucide-react'
...
export default function Toolbar() {
  const { isScanning, searchQuery, tracks, setTracks, setScanning, setSearchQuery } = useLibraryStore()
